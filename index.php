...
<div class="hero-slider">
    <?php
        while( $slider_query->have_posts() ) :
            ...
            $slider_meta = get_post_meta(get_the_ID(), '_slider_metaboxes', true);
            $button_text = $slider_meta['button_text'];
            $button_link = $slider_meta['button_link'];

            var_dump($slider_meta);
    ?>
    <div class="slider-item" style="background-image:url(<?php echo esc_url($image[0]); ?>);">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Slide Content Start-->
                    <div class="content style text-right">
                        <?php the_title('<h2 class="text-white">', '</h2>'); ?>
                        <p class="tag-text"><?php the_excerpt(); ?></p>

                        <?php if( ! empty($button_text) ) : ?>
                        <a href="<?php echo esc_url($button_link); ?>" class="btn btn-main btn-white"><?php echo esc_attr($button_text); ?></a>
                        <?php endif; ?>
                    </div>
                    <!-- Slide Content End-->
                </div>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="<?php echo get_template_directory_uri(); ?>/images/resource/1.png" alt="">
										</a>
									</figure>
								</div>
								<h6>Orthopedics</h6>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="<?php echo get_template_directory_uri(); ?>/images/resource/2.png" alt="">
										</a>
									</figure>
								</div>
								<h6>Diaginostic</h6>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="<?php echo get_template_directory_uri(); ?>/images/resource/3.png" alt="">
										</a>
									</figure>
								</div>
								<h6>Psycology</h6>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="<?php echo get_template_directory_uri(); ?>/images/resource/4.png" alt="">
										</a>
									</figure>
								</div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="tab-content">
                        <div class="service-box tab-pane fade in active row" id="dormitory">
                            <div class="col-md-6">
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/services/service-one.jpg" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                        ...
                        <div class="service-box tab-pane fade in" id="orthopedic">
                            <div class="col-md-6">
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/services/service-two.jpg" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                        ...
                        <div class="service-box tab-pane fade in" id="sonogram">
                            <div class="col-md-6">
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/services/service-three.jpg" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                        ...
                        <div class="service-box tab-pane fade in" id="x-ray">
                            <div class="col-md-6">
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/services/service-four.jpg" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                        ...
                        <div class="service-box tab-pane fade in" id="diagnostic">
                            <div class="col-md-6">
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/services/service-five.jpg" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
